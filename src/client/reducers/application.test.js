...
describe('Application Reducer', () => {
    ...
    describe(`Test action ${GLOBAL_MESSAGE_RECEIVED}`, () => {
        test(`Putting OK global message to store with initial state. Expectation: New state should contain the OK global message now.`, () => {
        ...
        test(`Putting OK global message to store with any state. Expectation: New state should contain the OK global message now.`, () => {
            const okMessage = createOkGlobalMessage();
        ...
        test(`Putting WARNING global message to store with initial state. Expectation: New state should contain the WARNING global message now.`, () => {
            const warningMessage = createWarningGlobalMessage();
        ...
        test(`Putting WARNING global message to store with any state. Expectation: New state should contain the WARNING global message now.`, () => {
            const warningMessage = createWarningGlobalMessage();
        ...
        test(`Putting ERROR global message to store with initial state. Expectation: New state should contain the ERROR global message now.`, () => {
            const errorMessage = createErrorGlobalMessage();
        ...
        test(`Putting ERROR global message to store with any state. Expectation: New state should contain the ERROR global message now.`, () => {
    ...
    describe(`Test action ${GLOBAL_MESSAGE_REMOVED}`, () => {
        ...
        test(`Removing global message from store with any state. Expectation: New state should be in initial state now.`, () => {
            const okMessage = createOkGlobalMessage();
    ...
    describe(`Test action ${LOADING_STATE_RECEIVED}`, () => {
        test(`Set loading state to TRUE with initial state before. Expectation: New state should contain the new loading state now.`, () => {
        ...
        test(`Set loading state to TRUE with state which also contains any global message. Expectation: New state should contain the new loading state now and the global message from before.`, () => {
            const okMessage = createOkGlobalMessage();
